<?php
    ...
    if($_SESSION['status']==1){
        $status = '<b style="color: green">Booked</b>';
    }
    else{
        $status = '<b style="color: red">Not Booked</b>';
    }
?>
...
<html>
    <head>
        <title>Online carwash system - Dashboard</title>
                    ...
                    if(isset($_SESSION['groups'])){
                        ...
                        for($i=0; $i<count($groups); $i++){
                            ?>
                                ...
                                <b>Booking :</b> <?php echo $groups[$i]['votes']?><br><br>
                                ...
                                if($_SESSION['status']==1){
                                    ?>
                                    <button disabled style="padding: 5px; font-size: 15px; background-color: #27ae60; color: white; border-radius: 5px;" type="button">Booked</button>
                                    <?php
                                }
                                else{
                                    ?>
                                    <button style="padding: 5px; font-size: 15px; background-color: #3498db; color: white; border-radius: 5px;" type="submit">Book</button>
                                    <?php
                                }
                                ?>
                                </form>
